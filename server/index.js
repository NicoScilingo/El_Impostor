          ...
          switch (action) {
            ...
            case 'showResults':
              ...
              if (room.votes.length < aliveCount) {
                // Not all votes have been cast; do not transition and notify client
                // Do not clear confirmations; all current confirmations remain.
                // Do not mark as executed
                executed = false;
                sendJson(400, {
                  error: 'Aún hay jugadores que no han votado. Todos deben votar antes de ver los resultados.',
                });
                return;
              }
              ...
              if (tieCount > 1) {
                // There is a tie; do not compute results and keep confirmations
                executed = false;
                sendJson(400, {
                  error: 'La votación está empatada. Debe haber una mayoría para eliminar a un jugador.',
                });
                return;
              }
